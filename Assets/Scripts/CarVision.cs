...
public class CarVision
{
    ...
    public void updateObserving()
    {
        ...
        dict_mat4.Clear();
        dict_mat4.Add("car", mat4x4toFloatArr(_carGameObject.transform.localToWorldMatrix));
        foreach (Collider coll in hitColliders)
        {
            changeMaterial(coll.gameObject, detectedMaterial);
            dict_mat4.Add(coll.gameObject.name, mat4x4toFloatArr(coll.gameObject.transform.localToWorldMatrix));
        }
